 ...
 */
public class GitLabClonerConfigurationException extends RuntimeException {
   ...
   * {@link #initCause}.
   */
  public GitLabClonerConfigurationException() {
    super();
  }
   ...
   */
  public GitLabClonerConfigurationException(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public GitLabClonerConfigurationException(Throwable cause) {
    super(cause);
  }
